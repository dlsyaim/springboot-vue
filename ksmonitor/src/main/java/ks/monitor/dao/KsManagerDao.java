...
public interface KsManagerDao{
	 ...
	 * @return
	 */
    int updateKsManager(@Param("enti") KsManager value, @Param("assist") Assist assist);
	/**
	 ...
	 * @return
	 */
    int updateNonEmptyKsManager(@Param("enti") KsManager value, @Param("assist") Assist assist);


	List<KsManager> queryList();
}